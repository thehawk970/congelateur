 ...
 */
final class Version20241021205429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, color_id, label FROM category');
        ...
        $this->addSql('INSERT INTO category (id, color_id, label) SELECT id, color_id, label FROM __temp__category');
